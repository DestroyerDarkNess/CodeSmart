...
#Region "Properties"
    ...
    Protected Overrides Sub OnMouseMove(e As MouseEventArgs)
        ...
        End If
        If e.Y > 26 Then Cursor = Cursors.Default Else Cursor = Cursors.Default
    End Sub
...
#Region "Declarations"
    ...
    Private leftSF As New StringFormat With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Far}
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With g
            ...
            For i = 0 To TabCount - 1
                ...
                Dim closebutton As New Rectangle(Base.Location, New Size(Base.Width - 100, Base.Height - 100))
