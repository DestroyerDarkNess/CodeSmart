...
Partial Class Step4
    ...
    Private Sub InitializeComponent()
        ...
        Me.XylosProgressBar1 = New InstallerSetup.XylosProgressBar()
        Me.StatusLabel = New InstallerSetup.LogInLabel()
    ...
    Friend WithEvents XylosProgressBar1 As InstallerSetup.XylosProgressBar
    Friend WithEvents StatusLabel As InstallerSetup.LogInLabel
