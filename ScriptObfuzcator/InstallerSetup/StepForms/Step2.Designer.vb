...
Partial Class Step2
    ...
    Private Sub InitializeComponent()
        ...
        Me.DeclineRadioButton = New InstallerSetup.KnightRadioButton()
        Me.AcceptRadioButton = New InstallerSetup.KnightRadioButton()
    ...
    Friend WithEvents DeclineRadioButton As InstallerSetup.KnightRadioButton
    Friend WithEvents AcceptRadioButton As InstallerSetup.KnightRadioButton
End Class
